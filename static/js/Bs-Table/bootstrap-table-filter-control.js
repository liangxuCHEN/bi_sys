    ...
    $.extend($.fn.bootstrapTable.defaults, {
        ...
        filterTemplate: {
            input: function (that, field, isVisible) {
                return sprintf('<input type="text" class="form-control %s" style="font:initial;font-size:12px;width: 100%; visibility: %s">', field, isVisible);
            },
            select: function (that, field, isVisible) {
                return sprintf('<select class="%s form-control" style="font:initial;font-size:12px;width: 100%; visibility: %s" dir="%s"></select>',
                    field, isVisible, getDirectionOfSelectOptions(that.options.alignmentSelectControlOptions));
            },
            datepicker: function (that, field, isVisible) {
                return sprintf('<input type="text" class="date-filter-control %s form-control" style="font:initial;font-size:12px;width: 100%; visibility: %s">', field, isVisible);
            }
        },
        //internal variables
        valuesFilterControl: []
