...
!function ($) {
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        this.$body.find('> tr[data-index] > td').off('click dblclick').on('click dblclick', function (e) {
            ...
            that.trigger(e.type === 'click' ? 'click-cell' : 'dbl-click-cell', field, value, item, $td, $el);
    ...
    BootstrapTable.prototype.ToSearch = function (text) {
        this.searchText = text;
        this.options.searchText = text;
    ...
    BootstrapTable.prototype.onColumnSearch = function (text) {
    };
    ...
    var allowedMethods = [
        ...
        'updateFormatText', 'ToSearch', 'onSort', 'getCaret'
    ];
